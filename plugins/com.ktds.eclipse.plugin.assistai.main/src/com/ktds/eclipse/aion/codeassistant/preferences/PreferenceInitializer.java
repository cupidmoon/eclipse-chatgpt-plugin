...
public class PreferenceInitializer extends AbstractPreferenceInitializer
{
    ...
    public void initializeDefaultPreferences()
    {
        ...
        store.setDefault( AionUPreferenceConstants.AION_CONNECTION_TIMEOUT_SECONDS, 10 );
        store.setDefault( AionUPreferenceConstants.AION_REQUEST_TIMEOUT_SECONDS, 30 );
        ...
        store.setDefault( AionUPreferenceConstants.AION_SELECTED_MODEL, gpt4.uid() );
        store.setDefault( AionUPreferenceConstants.AION_DEFINED_MODELS, modelsJson );
