...
public class ModelPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage
{
    ...
    private IPropertyChangeListener modelListener = e -> {
        if ( PreferenceConstants.AION_DEFINED_MODELS.equals( e.getProperty() ) )
        {
            uiSync.asyncExec( () -> {
    ...
    public void createFieldEditors()
    {
        ...
        var modelsJson = preferenceStore.getString( PreferenceConstants.AION_DEFINED_MODELS );
        ...
        ComboFieldEditor modelSelector = new ComboFieldEditor(PreferenceConstants.AION_SELECTED_MODEL, "&Selected Model:", entries, getFieldEditorParent());    
