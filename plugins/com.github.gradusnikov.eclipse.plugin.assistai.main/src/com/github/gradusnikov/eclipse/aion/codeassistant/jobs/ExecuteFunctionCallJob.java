package com.github.gradusnikov.eclipse.aion.codeassistant.jobs;
...
import com.github.gradusnikov.eclipse.aion.codeassistant.model.FunctionCall;
...
public class ExecuteFunctionCallJob extends Job
{
    ...
    {
        super( AionUJobConstants.JOB_PREFIX + " execute function call");
