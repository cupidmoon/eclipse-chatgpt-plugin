...
import static com.ktds.eclipse.aion.codeassistant.tools.ImageUtilities.createPreview;
...
import com.ktds.eclipse.aion.codeassistant.subscribers.AppendMessageToViewSubscriber;
...
public class ChatGPTPresenter
{
    ...
    private Preferences                   preferences           = InstanceScope.INSTANCE.getNode( "com.ktds.eclipse.aion.codeassistant" );
